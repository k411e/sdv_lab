...
class ClusterViewModel @Inject constructor(
    ...
    private fun increaseSpeed(increment: Int = 10) {
        val currentSpeed = state.value.speed
    ...
    private fun toggleLocation() {
        ...
        updateClusterState(currentState.copy(currentCentralScreen = CentralScreenState.MAP))
    }
    ...
    private fun frontParkingSensor() {
        val currentState = state.value
        updateClusterState(currentState.copy(currentCentralScreen = CentralScreenState.SENSORS))
    }
